...
export const hubs: Record<string, HubEditorial> = {
  ...
  activities: {
    ...
    faqs: [
      { q: "Are activities included in the tour price?", a: "No, and deliberately. Each is quoted separately and clearly so you can see what it adds before committing. Included in every journey are your licensed Egyptologist, private air-conditioned transfers, hotel pickup and drop-off, lunch on touring days and bottled water — plus entrance fees on multi-day journeys, while day tours leave monument tickets to be paid at the gate rate so you are never charged a markup on a government ticket. Activities sit outside that and are yours to choose." },
  ...
  guides: {
    ...
    faqs: [
      ...
      { q: "Do I need a visa for Egypt?", a: "It depends entirely on your passport. Most European, North American and Asia-Pacific nationals can buy a visa on arrival or apply for an e-Visa online; most Gulf (GCC) nationals do not need one; some nationalities must obtain the e-Visa in advance. The authority is the official Egyptian government portal at visa2egypt.gov.eg, and we confirm the rule for your passport when we plan the trip." },
