...
export const it: LocalizedPage[] = [
  ...
  // ===== Costi =============================================================
  {
    ...
    faqs: [
      ...
      { q: "Quanto mettere in conto per una settimana in Egitto?", a: "A livello privato e su misura, una settimana per due persone si colloca di norma fra 2.800 e 6.000 euro complessivi, a seconda di alberghi, stagione e se fra le città si vola o si guida. Voli internazionali, visto d'ingresso e mance restano fuori." },
