...
export const es: LocalizedPage[] = [
  ...
  // ===== Coste =============================================================
  {
    ...
    faqs: [
      ...
      { q: "¿Cuánto presupuestar para una semana en Egipto?", a: "En el nivel privado y a medida, una semana para dos personas suele situarse entre 2.800 y 6.000 euros en total, según hoteles, temporada y si entre ciudades se vuela o se conduce. Los vuelos internacionales, el visado de entrada y las propinas quedan fuera." },
